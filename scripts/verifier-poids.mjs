 ...
 * ouverte au README : cent trois kilo-octets pour une page pré-rendue dont l'interactivité
 * tient en une liste déroulante et deux boutons, c'est beaucoup. Un budget ne rend pas une
 * page légère ; il empêche qu'elle s'alourdisse sans que personne ne l'ait décidé.
 *
 * La marge est de 6 %, et non de 45 % comme celle des captures. La raison est que les cinq
 * fichiers de contenu sont DANS le paquet : une phrase ajoutée dans les cinq langues pèse,
 * et un budget serré ferait échouer la construction pour une correction de texte. Six pour
 * cent laissent passer une dizaine de chaînes et arrêtent une dépendance.
 *
 ...
 */
const BUDGETS = {
  'JavaScript du premier écran': 110 * 1024,
  'feuille de style du premier écran': 8 * 1024,
  'JavaScript de tout le site': 120 * 1024,
}
